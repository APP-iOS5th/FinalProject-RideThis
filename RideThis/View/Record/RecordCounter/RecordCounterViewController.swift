...
class RecordCounterViewController: UIViewController {
    
    var coordinator: RecordCountCoordinator?
    
    private var viewModel = RecordCountViewModel()
        ...
        private func setupBinding() {
            viewModel.$currentCount
                ...
                .sink { [weak self] newCount in
                    ...
                    if newCount == 0 {
                        self.coordinator?.countdownFinish()
                    }
                }
