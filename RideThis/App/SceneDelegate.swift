...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func getTabbarController(selectedIndex: Int = 0) -> UITabBarController {
        ...
        let myPageView = UINavigationController(rootViewController: MyPageView(viewModel: MyPageViewModel(firebaseService: FireBaseService(), periodCase: .oneWeek)))
